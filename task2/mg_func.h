...
extern void Multigrid(int gamma, int size, double cellLength, double** grid, double** source, FILE *fLog);
extern double GaussSeidel(int size, double cellLength, double** grid, double** rho, FILE* fLog);
